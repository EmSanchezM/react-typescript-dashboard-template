...
const MENU_ITEMS: MenuItemTypes[] = [
	{ key: 'cash-in', label: 'Cash in', isTitle: true, roles: [UserRolesEnum.SUPER_USER, UserRolesEnum.ADMIN_USER] },
	{
		key: 'transactions',
		label: 'Transactions',
		isTitle: false,
	...
	{ key: 'serviceChannels', label: 'Service Channels', isTitle: true, roles: [UserRolesEnum.ADMIN_USER, UserRolesEnum.ADMIN_USER], },
	{
		isTitle: false,
		key: 'payment-links',
		icon: 'bx bx-bell',
	...
	{ key: 'admin', label: 'Admin', isTitle: true, roles: [UserRolesEnum.SUPER_USER], },
	{
		isTitle: false,
		key: 'blacklist',
		icon: 'bx bx-bell',
	...
	{ key: 'settings', label: 'System settings', isTitle: true, roles: [UserRolesEnum.SUPER_USER] },
	{
		key: 'settings',
		label: 'Settings',
		isTitle: false,
...
const Sidebar = () => {
	...
	const [submenuVisible, setSubmenuVisible] = useState(new Array(MENU_ITEMS.length).fill(false));
		...
		<>
			<nav className="navbar">
				<div className="logo_item">
					<img src="/vite.svg" alt="clinpays" />Clinpays
			...
			<nav className={`sidebar ${sidebarClosed ? 'close' : ''}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
							...
							<li key={`${menuItem.key}_${index}`} className="item">
								{
									menuItem.isTitle ?
										...
										(
											...
											<div
												className={`nav_link submenu_item ${submenuVisible[index] ? 'show_submenu' : ''}`}
								...
								{menuItem.children && (
									<ul className="menu_items submenu">
										{menuItem.children.map((subItem, subIndex) => (
											<a href={subItem.url} key={subIndex} className="nav_link sublink">
												<span className="navlink_icon">
													<i className={menuItem.icon}></i>
												</span>
